...
final case class GraphletRequest(
    ...
    def withDocfreqThreshold(__v: _root_.scala.Int): GraphletRequest = copy(docfreqThreshold = __v)
    def withWeight(__v: _root_.scala.Int): GraphletRequest = copy(weight = __v)
