...
Usage:
$ python3 main.py --threshold 0.8 --sample-size 128
htnum 9
band_size 13

Code extracted from apollo:
https://github.com/src-d/apollo/blob/bbb9f83fffc93e791fa59f064efadefa270f400a/apollo/hasher.py#L38

which is based on https://github.com/ekzhu/datasketch/blob/master/datasketch/lsh.py
"""
...
def calc_hashtable_params(threshold,
                          sample_size,
